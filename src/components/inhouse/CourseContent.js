          ...
          <div className="grid gap-6 lg:grid-cols-2 lg:gap-12">
            <div>
              ...
              <p className="mt-4 text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
                Our MLT program provides comprehensive training in medical laboratory techniques, equipping you with the
                skills and knowledge to excel in the healthcare industry. Accredited by the National Accrediting Agency
                for Clinical Laboratory Sciences (NAACLS), the course covers a wide range of topics, including
                hematology, clinical chemistry, microbiology, and more.
              </p>
            ...
            <div className="grid gap-6">
              ...
              <div className="grid gap-1">
                ...
                <ul className="list-disc space-y-2 pl-6 text-gray-500 dark:text-gray-400">
                  <li>Hematology and Coagulation</li>
                  <li>Clinical Chemistry and Urinalysis</li>
                  <li>Microbiology and Immunology</li>
                  <li>Phlebotomy and Specimen Collection</li>
                  <li>Laboratory Instrumentation and Techniques</li>
                </ul>
              </div>
            </div>
          </div>
        ...
        <div className="container px-4 md:px-6">
          <div className="space-y-8">
            <div className="space-y-4 text-center">
              <h2 className="text-3xl text-center font-bold tracking-tighter sm:text-5xl">Frequently Asked Questions</h2>
