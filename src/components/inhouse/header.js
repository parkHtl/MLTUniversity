...
const Header = () => {
    return (
        <div className={'flex flex-col md:flex-row items-center w-full h-[50px] bg-[#1F3042] text-gray-300 text-[14px] px-[10px] py-[5px] md:px-[30px]'}>
            ...
            <div className={'flex justify-center md:justify-end w-full md:w-[50%] gap-5 md:gap-[10px]'}>
