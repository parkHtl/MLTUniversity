...
export default function Reference() {
  return (
    <div className="mt-10 mb-5">
      ...
      <div className="px-5  flex flex-wrap justify-center gap-8 rounded-3xl">
        <div className="md:w-[150px] md:h-[150px] w-[70px] h-[70px] flex-shrink-0 hover:scale-110 transform transition duration-500 ease-in-out">
          <img
